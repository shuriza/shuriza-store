...
@section('breadcrumb')
    ...
    <i class="fas fa-chevron-right text-[0.5rem] mx-1"></i> Tambah
@endsection
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        <label for="slug" class="block text-sm font-medium text-gray-300 mb-1.5">
                            Slug URL <span class="text-gray-500 text-xs">(otomatis dari nama)</span>
                        </label>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="8"
                                  ...
                                  class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-peri focus:border-transparent resize-y">{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="short_description" name="short_description" rows="3"
                                  ...
                                  class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-peri focus:border-transparent resize-y">{{ old('short_description') }}</textarea>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="number" id="price" name="price" required min="0"
                                   value="{{ old('price', 0) }}" placeholder="45000"
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="number" id="original_price" name="original_price" min="0"
                                   value="{{ old('original_price') }}" placeholder="99000"
                                   class="flex-1 bg-gray-800 border border-gray-700 rounded-r-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-peri focus:border-transparent">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="stock" name="stock" required min="0"
                               value="{{ old('stock', 0) }}" placeholder="100"
                               class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-peri focus:border-transparent">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="number" id="flash_sale_price" name="flash_sale_price" min="0"
                                   value="{{ old('flash_sale_price') }}" placeholder="25000"
                                   class="flex-1 bg-gray-800 border border-gray-700 rounded-r-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-peri focus:border-transparent">
                        </div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="badge_label" name="badge_label"
                               value="{{ old('badge_label') }}" placeholder="Teks custom badge"
                               class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-peri focus:border-transparent">
            ...
            <div class="bg-gray-900 rounded-2xl border border-gray-800">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <label class="flex items-center justify-between cursor-pointer group">
                        ...
                        <div class="relative" x-data="{ on: {{ old('is_popular', false) ? 'true' : 'false' }} }">
