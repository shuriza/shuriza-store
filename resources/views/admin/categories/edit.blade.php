...
@section('breadcrumb')
    ...
    <i class="fas fa-chevron-right mx-1 text-[0.5rem]"></i> Edit
@endsection
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                                  ...
                                  class="w-full rounded-xl border border-gray-700 bg-gray-800 px-4 py-3 text-white placeholder-gray-500 focus:border-transparent focus:ring-2 focus:ring-peri">{{ old('description', $category->description) }}</textarea>
